...
class TextEmbeddingBackbone(torch.nn.Module):
    ...
    def __init__(
            ...
            checkpoint_dir=None, freeze=False,
            pool_outputs=False):
        """
        ...
        if checkpoint_dir is not None:
            ...
            for key in list(checkpoint['state_dict'].keys()):
                ...
                checkpoint['state_dict'][new_key] = \
                    checkpoint['state_dict'].pop(key)
            # hide unexpected keys bias,fc.weight,fc.bias
    ...
    def __mean_pooling(self, model_output, attention_mask):
        ...
        pools along the sequence dimension
        all the padded tokens are ignored
        """
